...
#### [GitHub repository](https://github.com/icombs2017/Analysis-of-Fate-Tracked-Montastraea-cavernosa-Colonies.git){target="_blank"}
...
ggsave("../figures/loss.plots.tiff", plot= loss.plots.patch, width=15, height=10, units="in", dpi=600)
