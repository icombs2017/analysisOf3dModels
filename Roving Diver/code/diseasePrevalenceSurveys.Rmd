...
speciesData$nonSCTLDObvs <- speciesData$TotalObservations - speciesData$SCTLD
speciesData

ggplot(speciesData, aes(x = SpeciesCode, y = (TotalObservations < 500))) + geom_bar(stat = 'identity')

speciesPlot1 <- ggplot(speciesData, aes(x = SpeciesCode, y = TotalObservations))+geom_bar(stat = 'identity')+ facet_wrap( ~Location)
...
speciesPlotSLR <- ggplot(speciesSLR, aes(x = SpeciesCode, y = TotalObservations))+geom_bar(stat = 'identity')
speciesPlotJUP <- ggplot(speciesJUP, aes(x = SpeciesCode, y = TotalObservations))+geom_bar(stat = 'identity')
speciesPlotPB <- ggplot(speciesPB, aes(x = SpeciesCode, y = TotalObservations))+geom_bar(stat = 'identity')
speciesPlotPMP <- ggplot(speciesPMP, aes(x = SpeciesCode, y = TotalObservations))+geom_bar(stat = 'identity')
